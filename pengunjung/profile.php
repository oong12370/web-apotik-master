...
<table width="800px" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td> <p><span class="style1">User Peserta</span></p>
      <p>	<span class="style2">
        <?php 
	include '../temp/koneksi.php';
	$sql="select * from pendaftaran where email='".$_SESSION['user_forum']."'";
  ...
  <tr>
    <td bgcolor=""><form id="form1" name="form1" method="post" action="">
      <table width="673" border="0" cellpadding="0">
        ...
        <tr>
          <td width="217" rowspan="5" align="right" valign="top"><a href="../Image/<?=$row[foto]?>" target="_blank"><img src="../Image/<?=$row[foto]?>" width="200" height="300" border="0"/></a></td>
          <td width="144" align="right" ><div align="left" class="style4">Nama Peserta </div></td>
          <td width="13">:</td>
          <td width="289"><?php echo $row['nama'];?></td>
        </tr>
        <tr>
        ...
        <tr>
          <td align="right"><div align="left">Password</div></td>
          <td >:</td>

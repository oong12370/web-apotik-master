  ...
  <tr>
	...
	<ul class="menu">
      ...
      <li><a href="?page=profil">about</a>        </li>
			...
			<ul>
                  <li><a href="?page=input_konsumen" >Data Pelanggan</a></li>
                  <li><a href="?page=input_obat" >Data Obat</a></li>
				  <li><a href="?page=input_katagori" >Katagori obat</a></li>
              </ul>
			<li><a href="?page=coba">Transaksi </a>
			<ul>
			  </ul>
			<li><a href="#">lihat Data </a>
			<ul>
				<li><a href="?page=lap_ex" >Expired</a></li>
				<li><a href="?page=lap_transaksi" >Transaksi</a></li>
				<li><a href="?page=list_konsumen" >Konsumen</a></li>
				<li><a href="?page=list_obat" >Obat</a></li>
				
       		  </ul>
            <li><a href="?page=akun">Account</a>
